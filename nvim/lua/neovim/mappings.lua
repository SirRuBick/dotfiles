...
-- maps.n["<leader>ld"] = {"<cmd>Telescope lsp_document_diagnostics<cr>",desc = "Document Diagnostics" }
-- maps.n["<leader>lw"] = {"<cmd>Telescope lsp_workspace_diagnostics<cr>", desc = "Workspace Diagnostics"}
-- maps.n["<leader>lf"] = { "<cmd>lua vim.lsp.buf.formatting()<cr>", desc = "Format" }
-- maps.n["<leader>li"] = { "<cmd>LspInfo<cr>", desc = "Info" }
-- maps.n["<leader>lI"] = { "<cmd>LspInstallInfo<cr>", desc = "Installer Info" }
-- maps.n["<leader>lj"] = { "<cmd>lua vim.lsp.diagnostic.goto_next()<CR>", desc = "Next Diagnostic" }
-- maps.n["<leader>lk"] = { "<cmd>lua vim.lsp.diagnostic.goto_prev()<cr>", desc = "Prev Diagnostic" }
-- maps.n["<leader>ll"] = { "<cmd>lua vim.lsp.codelens.run()<cr>", desc = "CodeLens Action" }
-- maps.n["<leader>lq"] = { "<cmd>lua vim.lsp.diagnostic.set_loclist()<cr>", desc = "Quickfix" }
...
-- Custom menu for modification of the neovim experience
