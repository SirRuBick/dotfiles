--- ### Nvim LSP Utils
--
-- LSP related utility functions to use within ANvim and user configurations.
--
-- This module can be loaded with `local lsp_utils = require("utils.lsp")`
--
-- @module nvim.utils.lsp
-- @see nvim.utils
-- @copyright 2022
...
M.on_attach = function(client, bufnr)
  ...
  if capabilities.documentFormattingProvider and not tbl_contains(M.formatting.disabled, client.name) then
    ...
    then
      ...
      lsp_mappings.n["<leader>uf"] = {
        function() utils.ui.toggle_buffer_autoformat() end,
        desc = "Toggle autoformatting (buffer)",
      }
      lsp_mappings.n["<leader>uF"] = {
        function() utils.ui.toggle_autoformat() end,
  ...
  if capabilities.semanticTokensProvider and vim.lsp.semantic_tokens then
    lsp_mappings.n["<leader>uY"] = {
      function() utils.ui.toggle_buffer_semantic_tokens(bufnr) end,
  ...
  utils.set_mappings(lsp_mappings, { buffer = bufnr })  -- TODO: Custom mapping replace lsp_mappings
end
...
M.capabilities = M.capabilities -- TODO: Custom capahilities
-- M.flags = user_opts "lsp.flags" -- TODO: Custom flags
