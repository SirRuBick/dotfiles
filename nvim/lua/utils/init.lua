...
function M.get_icon(kind)
  ...
  if not M[icon_pack] then
    M.icons = require("neovim.icons.nerd_fonts")
    M.text_icons = require "neovim.icons.text"
  end
...
--- Toggle a neovim terminal if it exists, if not then create a new one and save it
...
function M.toggle_term_cmd(opts)
  local terms = neovim.neovim_terminals
...
---@param show_error? boolean Whether or not to show an unsuccessful command as an error to the neovim
